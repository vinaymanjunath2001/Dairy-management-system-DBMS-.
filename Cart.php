...
<ul class="list">
    ...
    <div class="form">
      <form action = "Dairypro.php" method="POST">
        ...
        <p class="details">
          ...
          <input type="text" name="customer_name" value="" required placeholder="NAME"/>
        </label>
        <label for="customer_mobile">
        Customer Mobile
          <input type="text" name="customer_mobile" value="" required placeholder="MOBILE" maxlength="10">
        </label>
  ...
  <!-- Now, the table data entries -->
          ...
          <tr>
            ...
            <td> <label for="id_1"> <input type="Checkbox" name="id_1" value="209&210" required/> 209 & 210  </label> </td>
          ...
          <tr>
            ...
            <td> <label for="id_2"> <input type="Checkbox" value="205"required name="id_2"/>   205</label> </td>
          ...
          <tr>
            ...
            <td> <label for="id_3"> <input type="Checkbox" name="id_3"  value="206" required/>   206</label> </td>
          ...
          <tr>
            ...
            <td> <label for="id_4"> <input type="Checkbox" name="id_4"  value="207" required/>   207</label> </td>
          ...
          <tr>
            ...
            <td> <label for="id_5"> <input type="Checkbox" name="id_5"  value="208" required/>   208</label> </td>
