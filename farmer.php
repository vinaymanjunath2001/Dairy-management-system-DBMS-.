...
<div id="editModal" class="modal">
  <form class="modal-content animate" action="edit.php" method="POST">
    <h3><b><u>Edit Farmer Details</u></b></h3>
    <div class="container">
      <input type="hidden" name="edit_id" id="edit_id" value="">
      <label for="edit_firstname">First Name <sup>*</sup></label>
      <input type="text" name="edit_firstname" id="edit_firstname" placeholder="Enter name of farmer" required/>
      <br>
      <label for="edit_ph">Phone number<sup>*</sup></label>
      <input type="text" name="edit_ph" id="edit_ph" placeholder="Phone Number" maxlength="10" required/>
      <br>
      <label for="edit_vid">Village ID<sup>*</sup></label>
      <input type="text" name="edit_vid" id="edit_vid" placeholder="Village" required/>
      <br>
      <label for="edit_milk_type">Milk Type<sup>*</sup></label>
      <input type="text" name="edit_milk_type" id="edit_milk_type" placeholder="Cow or Buffalo" required/>
      <br>
      <label for="edit_min_litre">Minimum Litre<sup>*</sup></label>
      <input type="number" name="edit_min_litre" id="edit_min_litre" placeholder="/day" maxlength="2" required/>
      <br>
      <label for="edit_animalID">Animal Health ID</label>
      <input type="text" name="edit_animalID" id="edit_animalID" placeholder="Issued by Health Ministry" maxlength="5"/>
      <br>
      <input type="submit" name="update_data" class="submit-btn-add" value="Update">
    </div>

    <div class="container" style="background-color:#f1f1f1">
      <button type="button" onclick="document.getElementById('editModal').style.display='none'" class="cancelbtn">Cancel</button>
    </div>
  </form>
</div>
    ...
    <div id="id01" class="modal">
      ...
      <h3>  <b> <u> Add new farmer</u></b> </h3>
        <div class="container">
                ...
                <input type="text" name="animalID" value="" placeholder="Issued by Health Ministry" maxlength="5"/>
                <br>
